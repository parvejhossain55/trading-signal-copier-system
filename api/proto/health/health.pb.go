...
const file_proto_health_health_proto_rawDesc = "" +
	"\n" +
	"\x19proto/health/health.proto\x12\x06health\x1a\x1fgoogle/protobuf/timestamp.proto\"I\n" +
	"\fHealthStatus\x129\n" +
	"\n" +
	"checked_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcheckedAt\"\x14\n" +
...
var file_proto_health_health_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_proto_health_health_proto_depIdxs = []int32{
	3, // 0: health.HealthStatus.checked_at:type_name -> google.protobuf.Timestamp
	3, // 1: health.HealthCheckResponse.timestamp:type_name -> google.protobuf.Timestamp
	1, // 2: health.HealthService.HealthCheck:input_type -> health.HealthCheckRequest
	2, // 3: health.HealthService.HealthCheck:output_type -> health.HealthCheckResponse
